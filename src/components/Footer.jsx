...
const Footer =()=>{
    ...
    <a className ="footer-ancle" href="https://drive.google.com/uc?id=1_rZ57kMWjuw9HEb9s1r1jkTTdHjRKCfB&export=download&authuser=0" target="blank"><i className="fas fa-file-download"></i></a>
  </footer>
    )
}
